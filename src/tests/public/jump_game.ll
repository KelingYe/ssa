...
bb12:
  %r133 = getelementptr i32, i32* %r100, i32 %r194
...
bb14:
  %r141 = getelementptr i32, i32* %r100, i32 %r194
...
bb20:
  %r157 = getelementptr [10 x i32 ], [10 x i32 ]* %r110, i32 0, i32 %r194
...
bb13:
  %r163 = getelementptr [10 x i32 ], [10 x i32 ]* %r110, i32 0, i32 0
...
main:
  ...
  %r206 = add i32 10, 0
  %r176 = call i32 @canJump(i32* %r165, i32 %r206)
  %r207 = add i32 %r176, 0
