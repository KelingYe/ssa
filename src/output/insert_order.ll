...
bb2:                                              ; preds = %bb3, %bb1
  ...
  %r108 = getelementptr i32, ptr %r100, i32 %r168
...
bb7:                                              ; preds = %bb6
  %r121 = sub i32 %r170, 1
  %r172 = add i32 %r121, 0
  %r124 = getelementptr i32, ptr %r100, i32 %r172
  %r123 = load i32, ptr %r124, align 4
  %r126 = getelementptr i32, ptr %r100, i32 %r170
  store i32 %r123, ptr %r126, align 4
  %r129 = getelementptr i32, ptr %r100, i32 %r168
  store i32 %r166, ptr %r129, align 4
  %r131 = sub i32 %r170, 1
  %r173 = add i32 %r131, 0
  br label %bb6
...
main:
  ...
  %r180 = add i32 %r145, 0
  %r146 = call i32 @insert(ptr %r132, i32 %r180)
  %r181 = add i32 %r146, 0
  br label %bb9
...
bb10:                                             ; preds = %bb9
  %r153 = getelementptr [11 x i32], ptr %r132, i32 0, i32 %r182
