...
bb7:                                              ; preds = %bb6
  ...
  %r121 = sub i32 %r120, 1
  %r223 = add i32 %r121, 0
  %r123 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r223
...
bb10:                                             ; preds = %bb9
  ...
  %r221 = add i32 %r133, 0
  %r135 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r221
...
bb16:                                             ; preds = %bb15
  ...
  %r161 = add i32 %r160, 1
  %r219 = add i32 %r161, 0
  %r164 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r218
  %r163 = load i32, ptr %r164, align 4
  %r167 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r219
  %r166 = load i32, ptr %r167, align 4
  %r168 = add i32 %r163, %r166
  %r170 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r217
...
bb14:                                             ; preds = %bb12
  %r176 = getelementptr [9 x i32], ptr %r108, i32 0, i32 0
