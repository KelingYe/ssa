...
bb1:                                              ; preds = %swap
  %r108 = getelementptr i32, ptr %r100, i32 %r225
  %r107 = load i32, ptr %r108, align 4
  %r227 = add i32 %r107, 0
  %r111 = getelementptr i32, ptr %r100, i32 %r226
  %r110 = load i32, ptr %r111, align 4
  %r113 = getelementptr i32, ptr %r100, i32 %r225
  store i32 %r110, ptr %r113, align 4
  %r116 = getelementptr i32, ptr %r100, i32 %r226
  store i32 %r227, ptr %r116, align 4
  ret i32 0
}
...
bb9:                                              ; preds = %bb4
  %r140 = getelementptr i32, ptr %r117, i32 %r242
  %r139 = load i32, ptr %r140, align 4
  %r143 = getelementptr i32, ptr %r117, i32 %r245
...
bb8:                                              ; preds = %bb7, %bb6
  ...
  %r149 = getelementptr i32, ptr %r117, i32 %r244
  %r148 = load i32, ptr %r149, align 4
  %r152 = getelementptr i32, ptr %r117, i32 %r246
  %r151 = load i32, ptr %r152, align 4
...
bb11:                                             ; preds = %bb8
  %r154 = call i32 @swap(ptr %r117, i32 %r244, i32 %r246)
  %r247 = add i32 %r154, 0
  %r248 = add i32 %r246, 0
  %r159 = mul i32 %r248, 2
  %r160 = add i32 %r159, 1
...
bb16:                                             ; preds = %bb15
  %r173 = sub i32 %r259, 1
  %r272 = add i32 %r173, 0
  %r174 = call i32 @heap_ajust(ptr %r161, i32 %r262, i32 %r272)
  %r273 = add i32 %r174, 0
  %r178 = sub i32 %r262, 1
  %r274 = add i32 %r178, 0
  br label %bb15
...
bb19:                                             ; preds = %bb18
  %r267 = add i32 0, 0
  %r184 = call i32 @swap(ptr %r161, i32 %r267, i32 %r266)
  %r268 = add i32 %r184, 0
  %r188 = sub i32 %r266, 1
  %r269 = add i32 %r188, 0
  %r189 = call i32 @heap_ajust(ptr %r161, i32 %r267, i32 %r269)
  %r270 = add i32 %r189, 0
  %r193 = sub i32 %r266, 1
  %r271 = add i32 %r193, 0
  br label %bb18
...
main:
  ...
  %r206 = call i32 @heap_sort(ptr %r194, i32 %r207)
  %r280 = add i32 %r206, 0
  br label %bb21
...
bb22:                                             ; preds = %bb21
  %r214 = getelementptr [10 x i32], ptr %r194, i32 0, i32 %r282
  %r213 = load i32, ptr %r214, align 4
  %r283 = add i32 %r213, 0
