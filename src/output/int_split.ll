...
bb4:                                              ; preds = %bb3
  ...
  %r123 = getelementptr i32, ptr %r113, i32 %r155
  store i32 %r120, ptr %r123, align 4
...
main:
  ...
  %r165 = add i32 1478, 0
  %r131 = call i32 @split(i32 %r165, ptr %r130)
  %r166 = add i32 %r131, 0
  %r167 = add i32 0, 0
  br label %bb6
...
bb7:                                              ; preds = %bb6
  %r138 = getelementptr [4 x i32], ptr %r130, i32 0, i32 %r168
