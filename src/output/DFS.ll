...
bb17:                                             ; preds = %addedge
  ...
  store i32 %r252, ptr %r132, align 4
  %r135 = getelementptr [1005 x i32], ptr @head, i32 0, i32 %r251
  ...
  %r140 = getelementptr [1005 x i32], ptr @head, i32 0, i32 %r251
  ...
  store i32 %r251, ptr %r145, align 4
  %r148 = getelementptr [1005 x i32], ptr @head, i32 0, i32 %r252
  ...
  %r153 = getelementptr [1005 x i32], ptr @head, i32 0, i32 %r252
...
bb19:                                             ; preds = %bb18
  %r159 = sub i32 0, 1
  %r161 = getelementptr [1005 x i32], ptr @head, i32 0, i32 %r256
...
bb24:                                             ; preds = %same
  %r177 = getelementptr [1005 x i32], ptr @vis, i32 0, i32 %r271
...
bb27:                                             ; preds = %bb26
  %r184 = getelementptr [1005 x i32], ptr @head, i32 0, i32 %r271
  %r183 = load i32, ptr %r184, align 4
  %r273 = add i32 %r183, 0
  br label %bb28
...
bb29:                                             ; preds = %bb28
  %r191 = getelementptr [5005 x i32], ptr @to, i32 0, i32 %r274
  %r190 = load i32, ptr %r191, align 4
  %r276 = add i32 %r190, 0
  %r194 = getelementptr [1005 x i32], ptr @vis, i32 0, i32 %r276
  %r193 = load i32, ptr %r194, align 4
...
bb33:                                             ; preds = %bb32
  %r202 = getelementptr [5005 x i32], ptr @next, i32 0, i32 %r274
  %r201 = load i32, ptr %r202, align 4
  %r277 = add i32 %r201, 0
  br label %bb28
