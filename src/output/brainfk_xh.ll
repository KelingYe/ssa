...
bb2:                                              ; preds = %bb1
  %r106 = call i32 @getch()
  %r108 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r187
...
bb4:                                              ; preds = %bb27, %interpret
  ...
  %r119 = getelementptr i32, ptr %r113, i32 %r197
  %r118 = load i32, ptr %r119, align 4
  %r120 = icmp ne i32 %r118, 0
  br i1 %r120, label %bb5, label %bb6

bb5:                                              ; preds = %bb4
  %r123 = getelementptr i32, ptr %r113, i32 %r197
...
bb13:                                             ; preds = %bb12
  ...
  %r136 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r134
  %r135 = load i32, ptr %r136, align 4
  %r137 = add i32 %r135, 1
...
bb16:                                             ; preds = %bb15
  ...
  %r144 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r142
...
bb19:                                             ; preds = %bb18
  ...
  %r152 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r150
...
bb28:                                             ; preds = %bb24
  ...
  %r162 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r160
  %r161 = load i32, ptr %r162, align 4
...
bb30:                                             ; preds = %bb29
  %r167 = sub i32 %r202, 1
  %r204 = add i32 %r167, 0
  %r170 = getelementptr i32, ptr %r113, i32 %r204
