...
bb3:                                              ; preds = %bb2
  ...
  %r312 = add i32 %r126, 0
  %r129 = getelementptr i32, ptr %r100, i32 %r312
  %r128 = load i32, ptr %r129, align 4
  %r131 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r285
  store i32 %r128, ptr %r131, align 4
  %r133 = add i32 %r285, 1
  %r313 = add i32 %r133, 0
  br label %bb2
...
bb6:                                              ; preds = %bb5
  ...
  %r140 = add i32 %r139, 1
  %r310 = add i32 %r140, 0
  %r143 = getelementptr i32, ptr %r100, i32 %r310
  %r142 = load i32, ptr %r143, align 4
  %r145 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r287
  store i32 %r142, ptr %r145, align 4
  %r147 = add i32 %r287, 1
  %r311 = add i32 %r147, 0
  br label %bb5
...
bb9:                                              ; preds = %bb11
  %r158 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r292
  %r157 = load i32, ptr %r158, align 4
  %r161 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r293
...
bb12:                                             ; preds = %bb9
  %r166 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r292
  %r165 = load i32, ptr %r166, align 4
  %r168 = getelementptr i32, ptr %r100, i32 %r294
  store i32 %r165, ptr %r168, align 4
  %r170 = add i32 %r294, 1
  %r306 = add i32 %r170, 0
  %r172 = add i32 %r292, 1
  %r307 = add i32 %r172, 0
...
bb13:                                             ; preds = %bb9
  %r175 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r293
  %r174 = load i32, ptr %r175, align 4
  %r177 = getelementptr i32, ptr %r100, i32 %r294
  store i32 %r174, ptr %r177, align 4
  %r179 = add i32 %r294, 1
  %r308 = add i32 %r179, 0
  %r181 = add i32 %r293, 1
  %r309 = add i32 %r181, 0
...
bb16:                                             ; preds = %bb15
  %r187 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r295
  %r186 = load i32, ptr %r187, align 4
  %r189 = getelementptr i32, ptr %r100, i32 %r296
  store i32 %r186, ptr %r189, align 4
  %r191 = add i32 %r296, 1
  %r301 = add i32 %r191, 0
  %r193 = add i32 %r295, 1
  %r302 = add i32 %r193, 0
...
bb19:                                             ; preds = %bb18
  %r199 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r297
  %r198 = load i32, ptr %r199, align 4
  %r201 = getelementptr i32, ptr %r100, i32 %r298
  store i32 %r198, ptr %r201, align 4
  %r203 = add i32 %r298, 1
  %r299 = add i32 %r203, 0
  %r205 = add i32 %r297, 1
  %r300 = add i32 %r205, 0
...
bb22:                                             ; preds = %bb21
  ...
  %r326 = add i32 %r218, 0
  %r220 = call i32 @MergeSort(ptr %r206, i32 %r322, i32 %r326)
  %r327 = add i32 %r220, 0
  %r224 = add i32 %r326, 1
  %r328 = add i32 %r224, 0
  %r225 = call i32 @MergeSort(ptr %r206, i32 %r328, i32 %r323)
  %r329 = add i32 %r225, 0
  %r228 = call i32 @Merge(ptr %r206, i32 %r322, i32 %r326, i32 %r323)
  %r330 = add i32 %r228, 0
  br label %bb24
...
main:
  ...
  %r246 = sub i32 %r245, 1
  %r336 = add i32 %r246, 0
  %r247 = call i32 @MergeSort(ptr %r232, i32 %r335, i32 %r336)
  %r337 = add i32 %r247, 0
  br label %bb25

bb25:                                             ; preds = %bb26, %main
...
bb26:                                             ; preds = %bb25
  %r255 = getelementptr [10 x i32], ptr %r232, i32 0, i32 %r338
  %r254 = load i32, ptr %r255, align 4
  %r340 = add i32 %r254, 0
