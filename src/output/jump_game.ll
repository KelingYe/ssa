...
bb4:                                              ; preds = %bb3
  %r106 = getelementptr i32, ptr %r100, i32 0
  %r105 = load i32, ptr %r106, align 4
  %r108 = sub i32 %r187, 2
...
bb8:                                              ; preds = %bb9, %bb7
  %r189 = phi i32 [ %r188, %bb7 ], [ %r203, %bb9 ]
  %r114 = sub i32 %r187, 1
...
bb11:                                             ; preds = %bb19, %bb10
  %r192 = phi i32 [ %r190, %bb10 ], [ %r196, %bb19 ]
  %r193 = phi i32 [ %r186, %bb10 ], [ %r197, %bb19 ]
  %r194 = phi i32 [ %r191, %bb10 ], [ %r198, %bb19 ]
  %r128 = sub i32 0, 1
  %r129 = icmp sgt i32 %r194, %r128
  br i1 %r129, label %bb12, label %bb13

bb12:                                             ; preds = %bb11
  %r133 = getelementptr i32, ptr %r100, i32 %r194
  %r132 = load i32, ptr %r133, align 4
  %r135 = sub i32 %r187, 1
  %r137 = sub i32 %r135, %r194
  %r138 = icmp slt i32 %r132, %r137
  br i1 %r138, label %bb14, label %bb15

bb14:                                             ; preds = %bb12
  %r141 = getelementptr i32, ptr %r100, i32 %r194
  %r140 = load i32, ptr %r141, align 4
  %r201 = add i32 %r140, 0
  br label %bb16

bb15:                                             ; preds = %bb12
  %r143 = sub i32 %r187, 1
  %r145 = sub i32 %r143, %r194
  %r202 = add i32 %r145, 0
  br label %bb16

bb16:                                             ; preds = %bb15, %bb14
  %r195 = phi i32 [ %r201, %bb14 ], [ %r202, %bb15 ]
  br label %bb17

bb17:                                             ; preds = %bb22, %bb16
  %r196 = phi i32 [ %r192, %bb16 ], [ %r199, %bb22 ]
  %r197 = phi i32 [ %r195, %bb16 ], [ %r200, %bb22 ]
  %r147 = sub i32 0, 1
  %r148 = icmp sgt i32 %r197, %r147
  br i1 %r148, label %bb18, label %bb19

bb18:                                             ; preds = %bb17
  %r151 = add i32 %r194, %r197
  %r199 = add i32 %r151, 0
  %r154 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r199
  %r153 = load i32, ptr %r154, align 4
  %r155 = icmp ne i32 %r153, 0
  br i1 %r155, label %bb20, label %bb21

bb20:                                             ; preds = %bb18
  %r157 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r194
...
bb13:                                             ; preds = %bb11
  %r163 = getelementptr [10 x i32], ptr %r110, i32 0, i32 0
...
main:
  ...
  %r206 = add i32 10, 0
  %r176 = call i32 @canJump(ptr %r165, i32 %r206)
  %r207 = add i32 %r176, 0
